    ...
    const onSubmit = (data) => {
        ...
        .then((result) => {
            if (result.success) {
                ...
                toast.error(result.error || "Unable to signup");
            }
        })
        .catch((err) => {
                    ...
                    <div className='flex flex-col lg:flex-row  gap-8'>
                        <div className='w-full'>
                            ...
                            <div>
                                ...
                                <input type='text' required {...register("userName")} placeholder='Ex: Ismaali Rihab' className='create-job-input placeholder:text-xs md:placeholder:text-sm'></input>
                            </div>
                            <div>
                                <label className='block mt-2 m-1 text-sm'>Email</label>
                                <input type='email' required {...register("userEmail")} placeholder='Ex: rihabismaali@gmail.com' className='create-job-input placeholder:text-xs md:placeholder:text-sm'></input>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type='text' required {...register("address")} placeholder='Ex: Sousse, Sousse, 4000' className='create-job-input placeholder:text-xs md:placeholder:text-sm'></input>
                            </div>
                            <div>
