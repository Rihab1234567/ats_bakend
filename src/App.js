...
import { EvaluationAuto } from './components/EvaluationAuto';
import { EvaluationForm } from './components/EvaluationForm';
import MessagerieCandidat from './Pages/Candidate/MessagerieCandidat';
import EmailAvancement from './Pages/Candidate/EmailAvancement';
    ...
    <div className="App">
      <Routes>
        <Route path='/' element={<Navbar />}>
          ...
          <Route path="/interview/all" element={<InterviewList />} />
          <Route path="/interview/:id" element={<InterviewDetails />} />
          <Route path="/interview/:id/evaluate" element={<EvaluationForm />} />
          <Route path="/evaluation-auto" element={<EvaluationAuto />} />
          <Route path='/messagerie/:candidatId' element={<MessagerieCandidat />} />
          <Route path='/notifier/:candidatId' element={<EmailAvancement />} />
